...
class NiceSelect{
  ...
  open(){ this.root.classList.add("open"); this.btn.setAttribute("aria-expanded","true"); this.q.value=""; this.hl=0; this.draw(); setTimeout(()=>this.q.focus(),30); }
  ...
  destroy(){ if(this.src){ this.src.style.display=""; this.root.remove(); } else { this.root.innerHTML=""; this.root.classList.remove("dd","open"); } }
}
