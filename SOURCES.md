...
## B Koodak (retired) — Borna Rayaneh (free download)
- Was: `BKOODB.woff2` (B Koodak Bold) subset to digits, vendored as
  `assets/fonts/bkoodak-700.woff2` and wired first in the `fa` stacks.
  Retired: digits now render in Vazirmatn (range extended to `U+0030–0039`);
  the woff2 was deleted and Persian-style digit shapes went with it.
